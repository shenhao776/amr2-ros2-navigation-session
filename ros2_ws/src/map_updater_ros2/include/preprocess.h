...
// 修改为 ROS2 的 Livox 消息头文件
#include <pcl_conversions/pcl_conversions.h>

#include <livox_ros_driver2/msg/custom_msg.hpp>
#include <sensor_msgs/msg/point_cloud2.hpp>  // 显式包含
...
class Preprocess {
 public:
  ...
  //  使用 livox_ros_driver2 的消息类型和 ROS2 的 ConstSharedPtr
  ...
  int lidar_type, N_SCANS;
  double blind, blind_sqr;
  int point_filter_num;

  // ros::Publisher pub_full, pub_surf, pub_corn; //
  // 移除，Preprocess类一般不直接持有ROS2 Publisher，或需改为rclcpp::Publisher
 ...
 private:
  ...
  void Pandar128_handler(
      const sensor_msgs::msg::PointCloud2::ConstSharedPtr& msg);
  void robosense_handler(
      const sensor_msgs::msg::PointCloud2::ConstSharedPtr& msg);
  void l515_handler(const sensor_msgs::msg::PointCloud2::ConstSharedPtr& msg);
  void give_feature(PointCloudXYZI& pl, vector<orgtype>& types);
  void pub_func(PointCloudXYZI& pl, const rclcpp::Time& ct);  // 修改 ros::Time
